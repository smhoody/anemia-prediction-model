...
- The repository example uses the Kaggle dataset `biswaranjanrao/anemia-dataset` when `kagglehub` is available; otherwise a synthetic dataset is generated for demonstration.
